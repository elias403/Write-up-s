...
<h2>Após fazer login no usuário hackable_3 executaremos o pspy (encurtador.com.br/gkrx2) ![teste](encurtador.com.br/gkrx2) - periodicamente  o root(UID=0) executado "python3 /scripts/to_hackable_3.py", indo até a pasta não existe o arquivo, então basta criarmos um arquivo com o mesmo caminho que será executado pelo root</h2>
